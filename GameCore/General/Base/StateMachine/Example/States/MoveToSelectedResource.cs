...
using Assets.Scripts.GameCore.API.Base;

namespace API.SM.Examples
{
    internal class MoveToSelectedResource : IState
    {
        ...
        private static readonly int Speed = Animator.StringToHash("Speed");// Převede string název na id, následné porovnání(u nastavování animace) je pak rychlejší => optimalizace
